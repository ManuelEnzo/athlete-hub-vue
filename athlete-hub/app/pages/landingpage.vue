    ...
    <nav class="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-lg">
      <div class="container mx-auto px-6 md:px-8 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div class="flex items-center gap-4 sm:gap-6 flex-shrink-0">
          ...
          <Button
            variant="outline" class="border-border rounded-full hover:bg-foreground hover:text-background transition-all px-6 sm:px-8 py-2 font-bold"
      ...
      <section class="relative pt-32 pb-40 px-6 overflow-hidden">
        <div class="container mx-auto text-center relative z-10">
          ...
          <div class="flex flex-col sm:flex-row justify-center gap-4 w-full max-w-xl mx-auto px-4">
            <Button
              size="lg" class="w-full sm:w-auto h-14 sm:h-16 px-6 sm:px-12 rounded-2xl bg-foreground text-background hover:opacity-90 text-lg md:text-xl font-bold group transition-transform active:scale-95"
              @click="scrollToWaitlist"
            >
            ...
            <Button
              size="lg" variant="ghost" class="w-full sm:w-auto h-14 sm:h-16 px-6 sm:px-10 text-lg text-muted-foreground hover:text-foreground font-semibold"
              @click="scrollToWaitlist"
            >
      ...
      <section class="py-32 px-6 bg-background/50">
        <div class="container mx-auto text-center">
          ...
          <div class="grid md:grid-cols-3 gap-10">
            ...
            >
              <img
                src="/calendar.png" alt="Calendar Preview"
            ...
            >
              <img
                src="/dettagli.png" alt="Calendar Preview"
                class="w-full aspect-[4/3] object-cover transition-transform duration-500 group-hover:scale-110 group-hover:brightness-110"
              >
              <div
                class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end justify-center pb-6"
        ...
        <div class="container mx-auto px-6">
          <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <h3 class="text-2xl font-bold mb-4 tracking-tight uppercase">
                {{ t(f.titleKey) }}
              </h3>
        ...
        <div class="container mx-auto px-6 text-center">
          ...
          <div class="grid md:grid-cols-3 gap-20 max-w-5xl mx-auto">
            <div v-for="(step, i) in roadmapSteps" :key="i" class="space-y-6">
              ...
              <h4 class="text-xl font-bold uppercase tracking-widest">
                {{ t(step.titleKey) }}
              </h4>
              <p class="text-xs font-mono text-muted-foreground italic">
                {{ t(step.dateKey) }}
              </p>
            </div>
          </div>
        ...
        <div class="max-w-md mx-auto">
          <div v-if="isSubmitted" class="text-center space-y-6 py-10 animate-in fade-in zoom-in duration-500">
            ...
            <div class="space-y-2">
              ...
              <p class="text-muted-foreground text-sm leading-relaxed">
                {{ t('landingpage.waitlist.successMessage') }}
              </p>
            </div>
            <Button
              variant="ghost" class="text-muted-foreground hover:text-foreground text-[10px] uppercase tracking-widest"
          ...
          <div v-else>
            <div class="text-center mb-12">
              <h2 class="text-4xl font-black tracking-tight mb-4 uppercase italic">
            ...
            <form class="space-y-6" @submit.prevent="handleFormSubmit">
              <div class="space-y-2">
                ...
                <Input
                  v-model="email" type="email" required :disabled="isSubmitting" :placeholder="t('landingpage.waitlist.placeholder')"
      ...
      <footer class="py-20 border-t border-border bg-accent/20">
        ...
        >
          ...
          <div class="flex gap-10">
            <NuxtLink to="/datapolicy" class="hover:text-foreground transition">
              {{ t('landingpage.footer.privacy') }}
            </NuxtLink>
            <a
              href="https://github.com/manuelenzo" target="_blank"
              class="hover:text-foreground transition font-bold underline"
