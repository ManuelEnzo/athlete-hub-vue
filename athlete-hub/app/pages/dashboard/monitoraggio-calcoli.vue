...
<template>
  <div class="w-full flex flex-col gap-6 mx-auto max-w-[1600px]">
    ...
    <div class="flex gap-6 items-start">
      ...
      <aside class="hidden xl:flex flex-col gap-0.5 w-56 shrink-0 sticky top-4">
      ...
      <div class="flex-1 space-y-4 min-w-0">
        ...
        <!-- S1: Time windows -->
        <section id="s1" class="bg-card border border-border rounded-xl p-5 space-y-3 scroll-mt-4">
        ...
        <!-- S2: Workload -->
        <section id="s2" class="bg-card border border-border rounded-xl p-5 space-y-3 scroll-mt-4">
        ...
        <!-- S3: ACWR -->
        <section id="s3" class="bg-card border border-border rounded-xl p-5 space-y-3 scroll-mt-4">
        ...
        <!-- S4: Monotony -->
        <section id="s4" class="bg-card border border-border rounded-xl p-5 space-y-3 scroll-mt-4">
        ...
        <!-- S5: Sleep Factor -->
        <section id="s5" class="bg-card border border-border rounded-xl p-5 space-y-3 scroll-mt-4">
        ...
        <!-- S6: Readiness -->
        <section id="s6" class="bg-card border border-border rounded-xl p-5 space-y-3 scroll-mt-4">
        ...
        <!-- S7: Injury Penalty -->
        <section id="s7" class="bg-card border border-border rounded-xl p-5 space-y-3 scroll-mt-4">
        ...
        <!-- S8: Pipeline -->
        <section id="s8" class="bg-card border border-border rounded-xl p-5 space-y-3 scroll-mt-4">
        ...
        <!-- S9: Predictions -->
        <section id="s9" class="bg-card border border-border rounded-xl p-5 space-y-3 scroll-mt-4">
        ...
        <!-- S10: Test comparison -->
        <section id="s10" class="bg-card border border-border rounded-xl p-5 space-y-3 scroll-mt-4">
        ...
        <!-- S11: Fallbacks -->
        <section id="s11" class="bg-card border border-border rounded-xl p-5 space-y-3 scroll-mt-4">
        ...
        <!-- S12: Summary -->
        <section id="s12" class="bg-card border border-border rounded-xl p-5 space-y-3 scroll-mt-4">
